...
<div class="car-info-box"> <a href="slot-book.php?wid=<?php echo htmlentities($result->wid);?>&amt=<?php echo htmlentities($result->price);?>"><img src="admin/img/warehouse/<?php echo htmlentities($result->image);?>" class="img-responsive" alt="image"></a>
<ul>
