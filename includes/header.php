  ...
  <nav id="navigation_bar" class="navbar navbar-default  <?php $isMobile ? 'fixed-top shadowed' : ''?>" style="<?php echo $navColor ?>">
    <div class="<?php echo $container ?>">
      <div class="navbar-header" style="padding-left:2rem !important;">
        <button id="menu_slide" data-target="#navigation" aria-expanded="false" data-toggle="collapse" class="navbar-toggle collapsed" type="button" text="" style="color:white !important; border: none !important; font-weight:600; top: -2px !important;"> <i class='fa fa-car fa-sm'></i>PARKLINE </button>
      ...
      <div class="header_wrap">
        ...
        <a href="" style="font-size: 25px;">PARKLINE </a>  
          <ul>
  ...
  <?php
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <?php if($_SESSION['login']){?>
            ...
            <li><a href='my-slot.php'>My Slot Booking</a></li>
          ...
          <li><a href='my-testimonials.php'>My Testimonial</a></li>
            ...
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">My Vehicle Slots</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation" style="background-color:#428bca; !important;" >
        ...
        <li><a href="index.php" style="font-size: 25px;">PARKLINE </a></li> 
          <li><a href="index.php" id="nav-home-button">Home</a></li>
          <li><a href="car-listing.php" id="nav-about-us-button">Vehical Rent</a></li>
          <li><a href="warehouse.php" id="nav-about-us-button">Slot Booking</a></li>
          <li><a href="about.php" id="nav-about-us-button">About Us</a></li>
